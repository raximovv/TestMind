...
var ARCHETYPES = {
  'ES|E': {name:'Xotirjam Yetakchi', slug:'xotirjam-yetakchi', fam:'lead',
  ...
  'E|C':  {name:'Gʻayratli Tashkilotchi', slug:'gayratli-tashkilotchi', fam:'lead',
  ...
  'ES|O': {name:'Xotirjam Kashfiyotchi', slug:'xotirjam-kashfiyotchi', fam:'crea',
  ...
  'E|O':  {name:'Gʻayratli Ijodkor', slug:'gayratli-ijodkor', fam:'crea',
  ...
  'O|C':  {name:'Ijodkor Strateg', slug:'ijodkor-strateg', fam:'crea',
  ...
  'ES|A': {name:'Ishonchli Doʻst', slug:'ishonchli-dost', fam:'care',
  ...
  'E|A':  {name:'Jamoaning Yuragi', slug:'jamoaning-yuragi', fam:'care',
  ...
  'O|A':  {name:'Ijodkor Insonparvar', slug:'ijodkor-insonparvar', fam:'care',
  ...
  'ES|C': {name:'Barqaror Strateg', slug:'barqaror-strateg', fam:'base',
  ...
  'A|C':  {name:'Ishonchli Tayanch', slug:'ishonchli-tayanch', fam:'base',
...
function tmFigure(o){
  ...
  var robe = o.robe, robeD = o.robeD, sleeve = o.sleeve || o.robeD, sash = o.sash;
  var s = '';
  ...
  s += '<path d="M68 94 Q100 84 132 94 L148 202 Q149 209 142 209 H58 Q51 209 52 202 Z" fill="'+robe+'"/>';
  ...
  s += '<g transform="rotate(10 78 100)"><rect x="69" y="100" width="18" height="64" rx="9" fill="'+sleeve+'"/>'
     + '<rect x="69" y="144" width="18" height="7" fill="'+robe+'"/></g>';
  s += '<g transform="rotate(-10 122 100)"><rect x="113" y="100" width="18" height="64" rx="9" fill="'+sleeve+'"/>'
     + '<rect x="113" y="144" width="18" height="7" fill="'+robe+'"/></g>';
  ...
  if (o.head === 'doppi'){
    var cap = o.cap || '#1A2748', capD = o.capD || '#101C38';
    s += '<path d="M68 46 Q68 12 100 12 Q132 12 132 46 Z" fill="'+cap+'"/>';
    s += '<g fill="#F4F7F8" opacity=".92"><path d="M100 17 q5.5 8 0 15 q-5.5 -7 0 -15z"/>'
       + '<path d="M82 25 q5.5 8 0 14 q-5.5 -6 0 -14z"/><path d="M118 25 q5.5 8 0 14 q-5.5 -6 0 -14z"/></g>';
    s += '<rect x="65" y="40" width="70" height="13" rx="4" fill="'+capD+'"/>';
    s += '<path d="M69 49 l5 -6 5 6 5 -6 5 6 5 -6 5 6 5 -6 5 6 5 -6 5 6 5 -6 5 6" '
       + 'stroke="#F4F7F8" stroke-width="1.7" fill="none" opacity=".85" stroke-linejoin="round"/>';
    ...
    s += '<g fill="#FFFFFF" opacity=".26"><circle cx="70" cy="74" r="2.7"/><circle cx="70" cy="92" r="2.7"/>'
       + '<circle cx="130" cy="74" r="2.7"/><circle cx="130" cy="92" r="2.7"/><circle cx="100" cy="26" r="2.7"/>'
       + '<circle cx="85" cy="30" r="2.7"/><circle cx="115" cy="30" r="2.7"/></g>';
  } else {
  ...
  if (o.glasses){
    s += '<g fill="none" stroke="#3A3340" stroke-width="2.6" stroke-linecap="round">'
       + '<circle cx="88" cy="59" r="10.5"/><circle cx="112" cy="59" r="10.5"/>'
       + '<path d="M98.5 59 h3"/><path d="M77.5 56 l-6 -2"/><path d="M122.5 56 l6 -2"/></g>';
  }
...
var TM_ART = {
  ...
  'O|C':  {head:'doppi', cap:'#2B2049', capD:'#1E1636', glasses:1, robe:'#6B54A0', robeD:'#4E3C78', sleeve:'#5D4890', sash:'#C08A2E', prop:'book'},
  ...
  'ES|C': {head:'doppi', cap:'#143F4E', capD:'#0C2F3C', glasses:1, robe:'#C08A2E', robeD:'#946420', sleeve:'#AC7727', sash:'#0F6E8C', prop:'rook'},
