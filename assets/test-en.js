...
var TEST_EN = {
  ...
  ui: {
    ...
    whySubject:  'and your results are strong in %1.',
    whyValue:    'and \'%1\' matters to you in a job.',
    recConflict: 'Worth noticing: your interests point towards %1, while your strongest marks point towards %2. Both are worth exploring — that is a choice, not a contradiction.',
    recNoSubjects: 'Add your school marks and these suggestions get sharper.',
    ...
    subjH:       'Your school marks',
    subjLede:    'Enter the ones you know — you do not need all of them. Skip any subject you are unsure about.',
    subjFive:    '2-5 scale',
    subjHundred: '0-100 scale',
    subjSelf:    'Roughly',
    subjClear:   'Clear all',
    subjHint:    'Marks are kept on this device only and are never sent anywhere.',
    ...
    lifeH:       'In everyday life',
    lifeSub:     'What comes easily, and where to pay attention.',
